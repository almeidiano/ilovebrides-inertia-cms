...
const WeddingDistrictiesItemChild = ({ parentId, childItem, childIndex, deleteWeddingChild, updateWeddingChildItem }) => {
    const [editMode, setEditMode] = useState(false);

    const handleSave = () => {
        updateWeddingChildItem(childItem.id, childItem.text, childItem.url);
        setEditMode(false);
    };
                    ...
                    {editMode ? (
                        ...
                        <>
                            ...
                            <div className='mx-4'>
                                ...
                                <IconButton onClick={() => deleteWeddingChild(childItem.id)} edge="end" aria-label="delete">
                                    <DeleteIcon />
                                </IconButton>
                            </div>
                        </>
...
export default WeddingDistrictiesItemChild;
